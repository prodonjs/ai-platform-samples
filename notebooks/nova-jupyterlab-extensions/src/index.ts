...
const jobsExtension: JupyterFrontEndPlugin<void> = {
  id: 'nova:jobs',
  activate: (app: JupyterFrontEnd, restorer: ILayoutRestorer) => {
    console.log('JupyterLab nova jobs extension is activated!');
    const sidePanel = new JobsWidget();
...
export class ButtonExtension implements
  ...
  createNew(
    ...
    const button = new ToolbarButton({
      ...
      iconClassName:
          iconStyle + ' jp-Icon jp-Icon-16 jp-ToolbarButtonComponent-icon',
      onClick: async () => {
...
export default [buttonExtension, jobsExtension];
